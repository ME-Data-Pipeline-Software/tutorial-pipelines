...
def test_custom_pipeline_tutorial_pipeline():
    ...
    test_file = "pipelines/custom_pipeline_tutorial/test/data/input/arctic_data.csv"
    expected_file = "pipelines/custom_pipeline_tutorial/test/data/expected/abc.example.a1.20220424.000000.nc"
